...
class InsertCompositeIndexBenchmarkUser(MongoUser):
    """Benchmark user that measures insert performance with a composite index."""
    ...
    @task(1)
    def insert_many_compositeIndex(self):
